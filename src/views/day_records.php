<main class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3><?= $today ?></h3>
            <p class="mb-0">Sua jornada de hoje</p>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer d-flex justify-content-center">
            <a href="../controllers/innout.php" class="btn btn-success btn-lg">
    ...
    <form class="mt-5" action="../controllers/innout.php" method="post">
        <div class="input-group no-border d-none">
            <input type="text" name="forcedTime" class="form-control" placeholder="informe a hora">
