<?php
    ...
    class WorkingHours extends Model {
        ...
        public function innout($time) {
            ...
            if(!$timeColumn) {
                throw new AppException("Você ja realizou sua jornada de trabalho diaria");
            }
        ...
        function getExitTime() {
            [$t1,,, $t4] = $this->getTimes();
            $workDay = DateInterval::createFromDateString('9 hours');
        ...
        function getBalance() {
            ...
            return "<p style='color:$color;'>$sign $balanceString<p>";
